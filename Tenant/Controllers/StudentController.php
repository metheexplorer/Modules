...
class StudentController extends BaseController
{
    ...
    {
        $payments = StudentPayment::where('course_application_id', $application_id)->select(['*']);
    ...
    function getInvoicesData($application_id)
    {
        ...
        $invoices = StudentInvoice::where('course_application_id', $application_id)->select(['*'])->orderBy('created_at', 'desc');
